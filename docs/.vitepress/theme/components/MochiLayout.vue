...
import { ref, watch, computed, nextTick, onMounted, provide } from 'vue'
  ...
  transition.ready.then(() => {
    ...
    document.documentElement.animate(
      ...
      },
      {
        ...
        easing: 'ease-out',
        fill: 'forwards',
        pseudoElement: data.isDark.value
...
<style lang="scss">
/* 禁用 View Transition 默认动画，避免与圆形扩散动画冲突 */
::view-transition-old(root),
::view-transition-new(root) {
  animation: none;
